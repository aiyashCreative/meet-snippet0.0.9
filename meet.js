...
const getQuery = () => {
    console.log('get query is triggered')
    ...
    if (meeting_id && meeting_token && username) {
        ...
        meetingVariables.id = meeting_id
        meetingVariables.token = meeting_token
        meetingVariables.name = username
        meetingObj.connect()
